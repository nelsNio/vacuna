...
public class RegimenResourceIntTest {
    ...
    public void setup() {
        ...
        final RegimenResource regimenResource = new RegimenResource(regimenRepository, regimenMapper);
    ...
    public void createRegimen() throws Exception {
        ...
        assertThat(testRegimen.getNombre()).isEqualTo(DEFAULT_NOMBRE);
    }
    ...
    public void updateRegimen() throws Exception {
        ...
        // Update the regimen
        Regimen updatedRegimen = regimenRepository.findOne(regimen.getId());
        ...
        Regimen testRegimen = regimenList.get(regimenList.size() - 1);
        assertThat(testRegimen.getNombre()).isEqualTo(UPDATED_NOMBRE);
    }
    ...
    public void updateNonExistingRegimen() throws Exception {
        ...
        // Validate the Regimen in the database
        List<Regimen> regimenList = regimenRepository.findAll();
        assertThat(regimenList).hasSize(databaseSizeBeforeUpdate + 1);
    }
